...
trap_dispatch(struct Trapframe *tf) {
    ...
    case IRQ_OFFSET + IRQ_CLOCK:
        ...
        // LAB 4: Your code here
        // if (strcmp(timer_for_schedule->timer_name, "hpet1"))
        //     rtc_check_status();
...
page_fault_handler(struct Trapframe *tf) {
    ...
    // LAB 9: Your code here:
    uintptr_t ursp = USER_EXCEPTION_STACK_TOP;
    ...
    // LAB 9: Your code here:
    struct UTrapframe local_copy;
    local_copy.utf_err = tf->tf_err;
    local_copy.utf_fault_va = fault_va;
    local_copy.utf_regs = tf->tf_regs;
    local_copy.utf_rflags = tf->tf_rflags;
    local_copy.utf_rsp = tf->tf_rsp;
    local_copy.utf_rip = tf->tf_rip;
    tf->tf_rsp = ursp;
    ...
    set_wp(0);
    nosan_memcpy((void *)ursp, (void *)&local_copy, sizeof(struct UTrapframe));
    set_wp(1);
